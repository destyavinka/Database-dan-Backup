                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card border-secondary text-center">
                                    <div class="card-body">
                                        <i class="fa fa-briefcase fa-4x mt-4"></i>
                                        <!-- <br><br>
                                        <span>
                                            Backup Project
                                        </span><br><br> -->
                                        <a href="project_backup.php" name="backup" class="btn btn-primary btn-block mt-5">Backup Project</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="card border-secondary text-center">
                                    <div class="card-body">
                                        <i class="fa fa-database fa-4x mt-4"></i>
                                        <!-- <br><br>
                                        <span>
                                            Backup Database
                                        </span><br><br> -->
                                        <a href="backup-data.php" name="backup" class="btn btn-primary btn-block mt-5">Backup Database</a>
                                    </div>
                                </div>
                            </div>
                        </div>
