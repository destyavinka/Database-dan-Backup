                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="table.php" aria-expanded="true"><i class="fa fa-table"></i><span>Materials</span></a>
                ...
                <body>
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-8 col-xlg-9">
                            <div class="card">
                                <div class="card-body">
                                    <form class="form-horizontal form-material mx-2" method="POST" action="additem.php">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <th>Rp. <?php echo $row["price"] * $row["quantity"] ?> </th>
