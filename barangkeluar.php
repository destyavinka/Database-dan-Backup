    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.php"><img src="assets/brand/Sastro-removebg-preview.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="table.php" aria-expanded="true"><i class="fa fa-table"></i><span>Material</span></a>
                ...
                <body>
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-8 col-xlg-9">
                            <div class="card">
                                <div class="card-body">
                                    <form class="form-horizontal form-material mx-2" method="POST" action=".php">
                                        <div class="form-group">
                                            <label class="col-md-12" for="name">Pilih Material</label>
